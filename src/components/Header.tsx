      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-6 h-10">
            <h2 className="text-2xl md:text-3xl font-light text-[#0EA5E9] tracking-wide will-change-transform">
              {displayText}
              <span className="cursor-blink">|</span>
            </h2>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-[#0EA5E9] animate-slide-in will-change-transform">
